  ...
  return (
    <main className="min-h-screen bg-[#0B111E] pt-36 pb-24 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        <p className="text-sm font-semibold tracking-[0.18em] uppercase text-blue-400 mb-4">Partners</p>
        <h1
          className="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.15] tracking-tight mb-12"
          style={{
