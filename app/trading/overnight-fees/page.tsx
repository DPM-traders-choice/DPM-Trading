      ...
      <section className="px-6 md:px-12 pt-36 pb-8 md:pb-10">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            >
              Trading positions may be rolled overnight. This is the process whereby your open position has its settlement date extended. At BBS Markets you may keep your positions open as per the company&apos;s Terms and Conditions.
            </p>
